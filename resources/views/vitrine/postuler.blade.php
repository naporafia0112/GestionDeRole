    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="text-center mb-4">
                ...
                <h1 class="display-6 fw-bold text-dark mb-2">Candidature</h1>
                <p class="lead text-muted">Postulez pour : <span class="text-primary fw-semibold">{{ $offre->titre ?? 'Offre' }}</span></p>
        ...
        <div class="col-xxl-10 col-xl-11">
            <div class="card border-0 shadow-lg">
                <div class="card-body p-0">
                    <form action="{{ route('candidature.store', $offre->id) }}" method="POST" enctype="multipart/form-data" id="candidatureForm" novalidate>
                        @csrf
                        ...
                        <div class="card-footer bg-light p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <a href="{{ route('vitrine.show', $offre->id) }}" class="btn btn-outline-secondary rounded-pill">
