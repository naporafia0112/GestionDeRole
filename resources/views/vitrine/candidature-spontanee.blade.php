    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    <h4 class="header-title mb-4">Candidature Spontanée</h4>

                    <form method="POST" action="{{ route('candidature.spontanee.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea id="message" name="message" rows="2" class="form-control" placeholder="Pourquoi souhaitez-vous postuler chez nous ?">{{ old('message') }}</textarea>
                            </div>
