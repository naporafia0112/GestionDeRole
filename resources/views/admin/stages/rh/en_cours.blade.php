...
<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <!-- Filtres par type de dépôt -->
            <ul class="nav nav-pills mb-3" id="typeDepotTabs">
                <li class="nav-item">
                    <a class="nav-link active" data-type="">Tous</a>
                </li>
                @foreach($typesDepot as $typeDepot)
                    <li class="nav-item">
                        <a class="nav-link" data-type="{{ $typeDepot }}">{{ ucfirst($typeDepot) }}</a>
                    </li>
                @endforeach
            </ul>
