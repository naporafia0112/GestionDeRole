            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('rh.stages.en_cours') }}">Stages en cours</a></li>
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="mb-1"><strong>Note :</strong></label>
                                <p>
                                    @if(isset($stage->note_finale) && $stage->note_finale !== null)
                                        {{ number_format($stage->note_finale, 0, ',', ' ') }}
                                    @else
