...
<div class="container mt-4">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Liste des Stages</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row mb-2">
                <div class="col-sm-4">
                    <a href="{{ route('stages.create') }}" class="btn btn-success mb-2">
                        <i class="fas fa-plus me-1"></i> Créer un stage
                    </a>
                </div>
                <div class="col-sm-8">
                    <div class="text-sm-end">
                        <!-- Boutons supplémentaires si besoin -->
                    </div>
                </div>
            </div>
                                ...
                                <table id="stages-datatable" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        @forelse($stages as $stage)
                                            <tr>
                                                <td>{{ $stage->candidat->nom ?? '' }} {{ $stage->candidat->prenom ?? '' }}</td>
