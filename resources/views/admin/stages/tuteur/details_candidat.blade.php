            ...
            <div class="page-title-box">
                <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.tuteur') }}">Tableau de bord</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('stages.candidats_tuteurs') }}">Candidats</a></li>
