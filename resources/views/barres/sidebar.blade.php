                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarEcommerce">
                                    <ul class="nav-second-level">
                                        ...
                                        <!--li>
                                            <a href="ecommerce-product-detail.html">Directeur</a>
                                        </!--li-->
                                        <!--li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarCrm">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="crm-dashboard.html">Académique</a>
                                        </li>
                                        <li>
                                            <a href="crm-contacts.html">Professionnel</a>
                                        </li>
                                        <li>
                                            <a href="crm-opportunities.html">Pré-embauche</a>
                                        </li>
                                        <!--li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarEmail">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="email-inbox.html">Rapports des Tuteurs</a>
                                        </li>
                                        <li>
                                            <a href="email-read.html">Rapports des Stagiares</a>
                                        </li>
                                        <li>
                                            <a href="email-compose.html">Attestations de fin de stage</a>
                                        </li>
                                        <li>
                                            <a href="email-templates.html">Conventions de stages</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarProjects">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="project-list.html">En ligne</a>
                                        </li>
                                        <li>
                                            <a href="project-detail.html">Présentiel</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
