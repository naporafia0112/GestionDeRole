                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td align="center"
                            ...
                            <br/>
                            <span style="margin-top: 10px; display: block; font-size: 16px;">Confirmation de votre candidature</span>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #24292e;">
                                            Nous avons bien reçu votre candidature et nous vous remercions pour l'intérêt que vous portez à notre entreprise. Vous pouvez suivre l'évolution de votre dossier en faisant une recherche sur le site via ce code ci-dessous.
                                        </p>
                                    </td>
                                </tr>
